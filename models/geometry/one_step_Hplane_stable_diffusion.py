...
from ..geometry.utils import contract_to_unisphere_custom, sample_from_Hplanes as sample_from_planes
from threestudio.utils.ops import get_activation
from threestudio.models.networks import get_encoding, get_mlp


@threestudio.register("one-step-Hplane-stable-diffusion")
class StableDiffusionHplaneAttention(BaseImplicitGeometry):
    @dataclass
    class Config(BaseImplicitGeometry.Config):
        ...
        backbone: str = "one_step_Hplane_stable_diffusion"
    ...
    def configure(self) -> None:
        ...
        if self.cfg.backbone == "one_step_Hplane_stable_diffusion":
            from ...extern.one_step_Hplane_sd_modules import OneStepHplaneStableDiffusion as Generator
    ...
    def interpolate_encodings(
        ...
        if self.cfg.rotate_planes == "v1":
            ...
            space_cache_rotated[:, 0::3] = torch.rot90(
                space_cache[:, 0::3], k=2, dims=(3, 4)
            )
            # zy plane - front view, rotate 90° clockwise
            space_cache_rotated[:, 1::3] = torch.rot90(
                space_cache[:, 1::3], k=-1, dims=(3, 4)
            )
